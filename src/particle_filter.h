...
class ParticleFilter {
	...
	std::array<double, 3> noiseFreePredictionComponent;
  ...
  std::vector<Particle> newParticles;
	...
	/**
	   ...
	   */
	  void associateSensedLandmarkstoMapLandmarks(Particle particle, const double sensor_range, std::vector<LandmarkObs> observations, const Map& map, std::vector<MappedLandmarks>& ApproxLanmarkObs_MapCoordinates);
...
/*  typedef struct _Particle {
	 ...
	 */
	void updateWeights(double sensor_range, const std::vector<double>& std_landmark, const std::vector<LandmarkObs> &observations,
